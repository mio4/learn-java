...
public class FlowMonitor extends Thread{
	 ...
	 */
	public synchronized void addFlow(int posx,int posy,int type){ //道路流量+1,type=0,右边; type=1，下边
	 ...
	 */
	public synchronized int getFlow(int posx,int posy, int type){ //返回指定边的道路流量
		if(type == Taxi.UP) {
