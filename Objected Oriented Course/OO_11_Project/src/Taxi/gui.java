...
class guigv {
	...
	public synchronized static void AddFlow(int x1, int y1, int x2, int y2) {// 增加一个道路流量
	...
	public synchronized static int GetFlow(int x1, int y1, int x2, int y2) {// 查询流量信息
	...
	public synchronized static void ClearFlow() {// 清空流量信息
		synchronized (guigv.flowmap) {
			synchronized (guigv.memflowmap) {
