...
import java.util.*;
/*
 *Overview: 调度器类：调度请求以及更改电梯的状态，对于处理后的请求需要输出
 */
public class ScheSon implements EMove{
	...
	/** @REQUIRES : None;
	 * @MODIFIES : req_list;
	 * @EFFECTS : this.req_list == req_list;
	 */
	...
	/** @REQUIRES : None;
	 * @MODIFIES : None;
	 * @EFFECTS : \request.equals("initialize the floors");
	 */
	...
	/** @REQUIRES : None;
	 * @MODIFIES : None;
	 * @EFFECTS : sch_return == false ==> \result == false;
	 * sch_return == true ==> \result == true;
	 */
	...
	/** @REQUIRES : None;
	 * @MODIFIES : None;
	 * @EFFECTS : \request.equals("the core of the scheduler : choose one request as the main request and others as the vice requests and schedule the elevator");
	 */
	...
	/** @REQUIRES : None;
	 * @MODIFIES : None;
	 * @EFFECTS : \request.equals(compare two request and if r1 < r2 return true else return false);
	 */
	public boolean LesserOrNot(Request r1, Request r2)
	{
		if(r1.get_location()<r2.get_location())
			return true;
		if(r1.get_location()==r2.get_location() && Double.doubleToLongBits(r1.get_time())<Double.doubleToLongBits(r2.get_time()))
			return true;
		return false;
	}
	...
	/** @REQUIRES : None;
	 * @MODIFIES : None;
	 * @EFFECTS : \result.equals("use bubble sort to sort the req_list array");
	 * \result == \new(req_list);
	 */
